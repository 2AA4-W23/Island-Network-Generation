...
public class NormalRender implements Renderable {
    ...
    private void drawPolygons(PolyMesh<? extends Polygons> polygons, Graphics2D canvas) {
        ...
        for (int index = 0; index < polygons.size(); index++){
            ...
            for (Structs.Vertex v: polygons.get(index).getVerticesList()) {
                ...
                alpha = alpha + Property.extractAlpha(v.getPropertiesList());
    ...
    private void drawSegments(PolyMesh<? extends Polygons> polygons, Graphics2D canvas, ArrayList<Structs.Vertex> vertices) {
        ...
        for (int index = 0; index < polygons.segmentSize(); index++) {
            ...
            Float thicknessV1 = Property.extractThickness(start_Point.getPropertiesList());
            Float thicknessV2 = Property.extractThickness(end_Point.getPropertiesList());
            ...
            // Get alpha
            Float alphaV1 = Property.extractAlpha(start_Point.getPropertiesList());
            Float alphaV2 = Property.extractAlpha(end_Point.getPropertiesList());
